...
public class MinOperationsTest {
    private final MinOperations minOperations = new MinOperations();
    ...
    public void test1() {
        ...
        int x = 5;
        Assertions.assertEquals(2, minOperations.minOperations(nums, x));
    }
    ...
    public void test2() {
        ...
        int x = 4;
        Assertions.assertEquals(-1, minOperations.minOperations(nums, x));
    }
    ...
    public void test3() {
        ...
        int x = 10;
        Assertions.assertEquals(5, minOperations.minOperations(nums, x));
    }
    ...
    public void test6() {
        ...
        int x = 565610;
        Assertions.assertEquals(113, minOperations.minOperations(nums, x));
    }
    ...
    public void test5() {
        ...
        int x = 134365;
        Assertions.assertEquals(16, minOperations.minOperations(nums, x));
    }
